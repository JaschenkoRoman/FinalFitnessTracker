...
<div class="wrapper">
    <div class="pane-wrapper">
        ...
        <div class="edit-panel content-panel pane">
            <form action="${pageContext.request.contextPath}/" method="post" id="edit-user-form" class="validate">
                    ...
                    <div class="common-program-info">
                        ...
                        <select name="role" class="service role input-field">
                            <c:forEach items="${requestScope.roles}" var="role">
                                <option class="service" ${requestScope.user.role eq role ? "selected" : ""} value="${role}"><fmt:message key="user.label.role.${fn:toLowerCase(role)}"/></option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
